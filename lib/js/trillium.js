(function() {
  ...
  Trillium = (function(_super) {
    ...
    Trillium.prototype.update = function(antagonist) {
      if (this.gamepad.index === 1) this.updateGamepad();
      return Trillium.__super__.update.call(this, antagonist);
    };
    ...
    Trillium.prototype.initGamepad = function(event) {
